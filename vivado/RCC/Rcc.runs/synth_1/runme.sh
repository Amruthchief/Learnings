...
HD_PWD='C:/Users/Amruth/Documents/vivado/Rcc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rcc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rcc.tcl
