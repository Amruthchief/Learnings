...
HD_PWD='C:/Users/Amruth/Documents/vivado/Rcc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rcc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rcc.tcl -notrace
